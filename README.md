...
2. Revise la clasificación **Técnico/Transversal** sugerida a partir del texto de las actividades. Cada competencia aparece una sola vez entre todos los programas. Puede corregirla con **Guardar clasificación de competencias**. Los códigos son los del Excel; la actividad de referencia permite identificarlos. No se transcriben horas docentes. La etapa productiva está excluida.
...
6. En **Instructores de planta**, ingrese **Nombre completo**, **Cédula**, **Tipo** y **Perfil**: para Técnico, el programa; para Transversal, el código de competencia. La capacidad transversal se comparte entre programas. Una cédula no puede repetirse porque duplicaría la capacidad. Deje vacío si no hay planta.
7. En **Planeación**, revise primero el pico simultáneo de contratistas y su trimestre. Debajo aparecen contratos con fechas, excedentes por trimestre, fichas por oferta, horas por ficha y mes, capacidad disponible por instructor y asignación mensual. Pulse **Ejecutar y guardar planeación** para conservar datos y habilitar el Excel actualizado.
...
La atención definida por el usuario es de **2 horas diarias de lunes a viernes**, equivalentes a **10 semanales por ficha** para el conjunto técnico activo y por cada competencia transversal activa. Varias actividades de una misma competencia no multiplican esta carga. Sin calendario de festivos cargado, el cálculo cuenta lunes a viernes sin descontar festivos.

Cada persona atiende fichas completas: 40/10 permite 4 a un contratista y 32/10 permite 3 a uno de planta. Primero se asigna planta y después se cubre el saldo con contratistas del perfil. Las dos horas libres de cada instructor de planta se muestran, pero no se suman entre personas para inventar otra ficha completa. El pico se calcula al cambiar los bloques, sin diluirlo en promedios mensuales. Los contratos pueden tener intervalos separados y su fecha final se limita a la vigencia proyectada.
