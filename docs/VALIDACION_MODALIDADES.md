...
- La carga técnica es 2 horas diarias por ficha de lunes a viernes: 10 semanales para el conjunto técnico activo. La carga transversal es 2 horas **semanales** por competencia activa y ficha. Se agrupan los resultados repetidos de la misma competencia y bloque. Las técnicas comparten el perfil del programa.
...
- La capacidad técnica permanece en 3 fichas por planta de 32 h/sem y 4 por contratista de 40 h/sem. En transversal las mismas capacidades permiten 16 y 20 atenciones semanales de una competencia por ficha. Una ficha con dos competencias del mismo perfil requiere dos atenciones. Los cupos se obtienen de la división de horas disponibles entre horas de atención, no de una regla por nombre de competencia. La cédula única impide contar una persona dos veces.
- El centro confirmó que un mismo instructor cubre todos los temas transversales excepto bilingüismo. `config/virtual_staffing.json` registra los perfiles general y bilingüismo. La fuente del SENA para identificar el código 240202501 está en `config/virtual_competency_references.json`; se usa para reconocer el idioma, no para determinar su carga o contratación. Las correcciones manuales del perfil se conservan.
...
Tres bloques consecutivos de siete días, con el segundo transversal, generan 22 horas por ficha (10 + 2 + 10), aunque el Excel incluya otras horas de referencia. Dos fichas que pasan con fin lectivo 14/01/2027 tienen 12 horas pendientes cada una. Con meta 100 y 25 aprendices por ficha entran dos nuevas: 24 pendientes + 44 nuevas = **68 horas**.

Con bloques de 7, 14 y 7 días, el segundo transversal, una ficha demanda 24 horas. Si hay una persona de planta transversal, solo se requieren contratos técnicos del 01–07/01 y 22–28/01.

Cuatro fichas técnicas simultáneas del mismo perfil caben en un contratista; cinco requieren dos. Una persona de planta técnica cubre tres; la cuarta requiere contratación. Cuatro fichas de dos programas que comparten una competencia transversal generan 8 h/sem, cubiertas por una persona de planta. Diez fichas con dos competencias transversales compatibles generan 40 h/sem y caben en un contratista; repetir resultados de una de esas competencias no añade horas.
...
`test_virtual_transversal_load.py` comprueba capacidad derivada con códigos arbitrarios, fin de carga al terminar el bloque, suma de competencias compatibles sin duplicar resultados, separación de bilingüismo, correcciones de perfil y conservación exacta de resultados técnicos al cambiar la carga transversal. La identificación de lengua inglesa se contrastó con la [Circular 196 de 2024 del SENA](https://normograma.sena.edu.co/compilacion/docs/circular_sena_0196_2024.htm).
